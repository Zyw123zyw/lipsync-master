...
namespace Function
{
    class PIPNet : public BasicTRTHandler
    {
    public:
        explicit PIPNet(const std::string &_engine_path);
        ~PIPNet() override = default;
    ...
    private:
        ...
        void generate_landmarks(std::vector<cv::Point2i> &landmarks,
